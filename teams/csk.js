    ...
    players.forEach(player => {
        ...
        listItem.innerHTML = `
                ...
                <div style="display:flex; flex-direction: row; flex-wrap:wrap; gap:15px;">
                    ...
                    <div style = "width:350px; height:300px; border: 2px solid black; display:flex; flex-direction: column; gap: 10px;  flex-wrap:wrap;" >

                        <img src="${player.Image}" alt="${player.playerName}" style = " width:150px; height:150px; border: none; border-radius: 100px; margin-left:90px;" >
                        <h2>${player.playerName}</h2>
                        <p>Team: ${player.from}</p>
                        <p>Price: ${player.price || 'N/A'}</p>
