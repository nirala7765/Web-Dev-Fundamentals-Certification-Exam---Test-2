...
function displayPlayerInfo(player) {
    const playerInfoElement = document.getElementById('playerInformation');
    if (player) {
        playerInfoElement.innerHTML = `
            <h2  style="color: black; margin-top: 0px; text-align:center; font-size: 30px;">${player.name}</h2>
            <p style="color: black; margin-top: 0px; text-align:center; font-size: 20px;">Age: ${player.age}</p>
            <p style="color: black; margin-top: 0px; text-align:center; font-size: 20px;">Team: ${player.team}</p>
            
           
        `;
    } else {
        playerInfoElement.innerHTML = "<p style='color: black;  text-align:center;  font-size: 20px;'>Player Not Found<br>Or check spelling</p>";
    }
}
